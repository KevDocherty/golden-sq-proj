...
```ruby
grammar_good = check_grammar(text)

```

# * 'text' is a string of words
# * 'grammar_good' is a boolean indicating whether test passed
# * where we're testing whether the text begins with a capital and ends with '.'
