...
class TaskList
  ...
  def read_tasks
    # return a list of oustanding tasks as strings
  end
  
  def delete_task(task)    # task is a string
    # remove the specified task from the task list
    # fails if the specified task doesn't exist: 'no such task!'
  end
